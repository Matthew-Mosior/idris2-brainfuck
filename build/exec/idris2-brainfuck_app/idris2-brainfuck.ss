...
;; @generated by Idris 0.7.0-e3413689a, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define NetworkC-45FFI-prim__idrnet_connect (lambda (farg-0 farg-1 farg-2 farg-3 farg-4 farg-5) ((foreign-procedure "idrnet_connect" (int int int string int) int) farg-0 farg-1 farg-2 farg-3 farg-4)))
...
(define csegen-2 (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8945) (u--func arg-8945))))))
(define csegen-13 (vector (vector csegen-2 (lambda (u--a) (lambda (arg-9991) arg-9991)) (lambda (u--b) (lambda (u--a) (lambda (arg-9997) (lambda (arg-10004) (arg-9997 arg-10004)))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10477) (lambda (arg-10480) (arg-10480 arg-10477))))) (lambda (u--a) (lambda (arg-10491) arg-10491))))
(define ControlC-45MonadC-45StateC-45State-u--C-60C-42C-62_Applicative_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36fC-41 (lambda (arg-4 arg-5 arg-6 ext-0) (let ((e-2 (vector-ref arg-4 1))) ((((e-2 'erased) 'erased) (arg-5 ext-0)) (lambda (_-0) (let ((e-5 (car _-0))) (let ((e-4 (cdr _-0))) (let ((e-7 (vector-ref arg-4 1))) ((((e-7 'erased) 'erased) (arg-6 e-5)) (lambda (_-1) (let ((e-10 (car _-1))) (let ((e-9 (cdr _-1))) (let ((e-13 (vector-ref arg-4 0))) (let ((e-15 (vector-ref e-13 1))) ((e-15 'erased) (cons e-10 (e-4 e-9)))))))))))))))))
(define ControlC-45MonadC-45StateC-45State-u--C-62C-62C-61_Monad_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36mC-41 (lambda (arg-4 arg-5 arg-6 ext-0) (let ((e-2 (vector-ref arg-4 1))) ((((e-2 'erased) 'erased) (arg-5 ext-0)) (lambda (_-0) (let ((e-5 (car _-0))) (let ((e-4 (cdr _-0))) ((arg-6 e-4) e-5))))))))
(define ControlC-45MonadC-45StateC-45State-u--join_Monad_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36mC-41 (lambda (arg-3 arg-4 ext-0) (ControlC-45MonadC-45StateC-45State-u--C-62C-62C-61_Monad_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36mC-41 arg-3 arg-4 (lambda (eta-0) eta-0) ext-0)))
(define ControlC-45MonadC-45StateC-45State-u--map_Functor_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36fC-41 (lambda (arg-4 arg-5 arg-6 ext-0) ((((arg-4 'erased) 'erased) (lambda (eta-0) (let ((e-2 (car eta-0))) (let ((e-3 (cdr eta-0))) (cons e-2 (arg-5 e-3)))))) (arg-6 ext-0))))
(define ControlC-45MonadC-45StateC-45State-u--pure_Applicative_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36fC-41 (lambda (arg-3 arg-4 ext-0) (let ((e-1 (vector-ref arg-3 0))) (let ((e-5 (vector-ref e-1 1))) ((e-5 'erased) (cons ext-0 arg-4))))))
(define csegen-25 (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8945) (lambda (eta-0) (ControlC-45MonadC-45StateC-45State-u--map_Functor_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36fC-41 csegen-2 u--func arg-8945 eta-0)))))) (lambda (u--a) (lambda (arg-9991) (lambda (eta-0) (ControlC-45MonadC-45StateC-45State-u--pure_Applicative_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36fC-41 csegen-13 arg-9991 eta-0)))) (lambda (u--b) (lambda (u--a) (lambda (arg-9997) (lambda (arg-10004) (lambda (eta-0) (ControlC-45MonadC-45StateC-45State-u--C-60C-42C-62_Applicative_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36fC-41 csegen-13 arg-9997 arg-10004 eta-0))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10477) (lambda (arg-10480) (lambda (eta-0) (ControlC-45MonadC-45StateC-45State-u--C-62C-62C-61_Monad_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36mC-41 csegen-13 arg-10477 arg-10480 eta-0)))))) (lambda (u--a) (lambda (arg-10491) (lambda (eta-0) (ControlC-45MonadC-45StateC-45State-u--join_Monad_C-40C-40StateTC-32C-36stateTypeC-41C-32C-36mC-41 csegen-13 arg-10491 eta-0))))))
(define PreludeC-45IO-u--map_Functor_IO (lambda (arg-2 arg-3 ext-0) (let ((act-2 (arg-3 ext-0))) (arg-2 act-2))))
(define csegen-42(delay (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8945) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8945 eta-0)))))) (lambda (u--a) (lambda (arg-9991) (lambda (eta-0) arg-9991))) (lambda (u--b) (lambda (u--a) (lambda (arg-9997) (lambda (arg-10004) (lambda (world-4) (let ((act-5 (arg-9997 world-4))) (let ((act-3 (arg-10004 world-4))) (act-5 act-3))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10477) (lambda (arg-10480) (lambda (world-0) (let ((act-1 (arg-10477 world-0))) ((arg-10480 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10491) (lambda (world-0) (let ((act-1 (arg-10491 world-0))) (act-1 world-0))))))))
(define csegen-43 (cons (force csegen-42) (lambda (u--a) (lambda (arg-13090) arg-13090))))
...
(define csegen-50 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Int arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Int arg-722 arg-725)))))
(define csegen-60 (lambda (eta-0) (lambda (eta-1) (cons eta-0 eta-1))))
(define csegen-119 (vector (lambda (arg-5944) (lambda (arg-5947) (bs+ arg-5944 arg-5947 63))) (lambda (arg-5954) (lambda (arg-5957) (bs* arg-5954 arg-5957 63))) (lambda (arg-5964) (blodwen-toSignedInt arg-5964 63))))
...
(define Main-n--5990-5709-u--loop (lambda (arg-0 arg-1) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (if (null? e-2) (cons '() (PreludeC-45TypesC-45List-reverse e-3)) (let ((e-6 (car e-2))) (let ((e-7 (cdr e-2))) (cond ((equal? e-6 #\+) (Main-n--5990-5709-u--loop arg-0 (cons e-7 (cons (vector 0 1) e-3)))) ((equal? e-6 #\-) (Main-n--5990-5709-u--loop arg-0 (cons e-7 (cons (vector 0 -1) e-3)))) ((equal? e-6 #\>) (Main-n--5990-5709-u--loop arg-0 (cons e-7 (cons (vector 2 ) e-3)))) ((equal? e-6 #\<) (Main-n--5990-5709-u--loop arg-0 (cons e-7 (cons (vector 1 ) e-3)))) ((equal? e-6 #\.) (Main-n--5990-5709-u--loop arg-0 (cons e-7 (cons (vector 3 ) e-3)))) ((equal? e-6 #\[) (let ((sc3 (Main-n--5990-5709-u--loop arg-0 (cons e-7 '())))) (let ((e-5 (car sc3))) (let ((e-4 (cdr sc3))) (Main-n--5990-5709-u--loop arg-0 (cons e-5 (cons (vector 4 e-4) e-3))))))) ((equal? e-6 #\]) (cons e-7 (PreludeC-45TypesC-45List-reverse e-3)))(else (Main-n--5990-5709-u--loop arg-0 (cons e-7 e-3)))))))))))
...
(define Main-accCheckSum (lambda (arg-0 arg-1) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (let ((u--sC-8321C-39 (PreludeC-45Num-u--mod_Integral_Int (bs+ e-2 arg-0 63) (blodwen-toSignedInt 255 63)))) (let ((u--sC-8322C-39 (PreludeC-45Num-u--mod_Integral_Int (bs+ u--sC-8321C-39 e-3 63) (blodwen-toSignedInt 255 63)))) (cons u--sC-8321C-39 u--sC-8322C-39)))))))
(define ControlC-45MonadC-45StateC-45Interface-modify (lambda (arg-2 arg-3) (let ((e-2 (vector-ref arg-2 0))) (let ((e-7 (vector-ref e-2 1))) ((((e-7 'erased) 'erased) (let ((e-10 (vector-ref arg-2 1))) e-10)) (lambda (u--s) (let ((e-9 (vector-ref arg-2 2))) (e-9 (arg-3 u--s)))))))))
(define Main-u--write_Ctx_Quiet (lambda (arg-0) (ControlC-45MonadC-45StateC-45Interface-modify (vector csegen-25 (lambda (u--x) (cons u--x u--x)) (lambda (arg-2196) (lambda (u--y) (cons arg-2196 'erased))) (lambda (u--a) (lambda (arg-2203) (lambda (eta-0) (arg-2203 eta-0))))) (lambda (eta-0) (Main-accCheckSum arg-0 eta-0)))))
...
(define Main-u--write_Ctx_Loud (lambda (arg-0 ext-0) (let ((act-1 (PreludeC-45IO-prim__putChar (cast-int-char arg-0) ext-0))) ((SystemC-45FileC-45Process-fflush csegen-43 SystemC-45FileC-45Virtual-stdout) ext-0))))
(define Main-parse (lambda (arg-0) (let ((sc0 (Main-n--5990-5709-u--loop arg-0 (cons arg-0 '())))) (let ((e-3 (cdr sc0))) e-3))))
(define Builtin-fst (lambda (arg-2) (let ((e-2 (car arg-2))) e-2)))
(define Main-current (lambda (arg-0) (let ((e-1 (vector-ref arg-0 1))) e-1)))
(define Main-inc (lambda (arg-0 arg-1) (let ((e-0 (vector-ref arg-1 0))) (let ((e-1 (vector-ref arg-1 1))) (let ((e-2 (vector-ref arg-1 2))) (vector e-0 (bs+ e-1 arg-0 63) e-2))))))
(define Main-decomp (lambda (arg-0) (if (null? arg-0) (cons '() 0) (let ((e-1 (car arg-0))) (let ((e-2 (cdr arg-0))) (cons e-2 e-1))))))
(define Main-left (lambda (arg-0) (let ((e-0 (vector-ref arg-0 0))) (let ((e-1 (vector-ref arg-0 1))) (let ((e-2 (vector-ref arg-0 2))) (let ((sc0 (Main-decomp e-0))) (let ((e-4 (car sc0))) (let ((e-3 (cdr sc0))) (vector e-4 e-3 (cons e-1 e-2))))))))))
(define Main-right (lambda (arg-0) (let ((e-0 (vector-ref arg-0 0))) (let ((e-1 (vector-ref arg-0 1))) (let ((e-2 (vector-ref arg-0 2))) (let ((sc0 (Main-decomp e-2))) (let ((e-4 (car sc0))) (let ((e-3 (cdr sc0))) (vector (cons e-1 e-0) e-3 e-4)))))))))
(define Main-run (lambda (arg-1 arg-2 arg-3) (if (null? arg-2) (let ((e-1 (car arg-1))) (let ((e-5 (vector-ref e-1 0))) (let ((e-7 (vector-ref e-5 1))) ((e-7 'erased) arg-3)))) (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (case (vector-ref e-2 0) ((0) (let ((e-0 (vector-ref e-2 1))) (Main-run arg-1 e-3 (Main-inc e-0 arg-3)))) ((1) (Main-run arg-1 e-3 (Main-left arg-3))) ((2) (Main-run arg-1 e-3 (Main-right arg-3))) ((3) (let ((e-1 (car arg-1))) (let ((e-6 (vector-ref e-1 1))) ((((e-6 'erased) 'erased) (let ((e-8 (cdr arg-1))) (e-8 (Main-current arg-3)))) (lambda (_-10718) (Main-run arg-1 e-3 arg-3)))))) (else (let ((e-1 (vector-ref e-2 1))) (let ((u--op (vector 4 e-1))) (let ((sc2 (Main-current arg-3))) (cond ((equal? sc2 0) (Main-run arg-1 e-3 arg-3))(else (let ((e-5 (car arg-1))) (let ((e-7 (vector-ref e-5 1))) ((((e-7 'erased) 'erased) (Main-run arg-1 e-1 arg-3)) (lambda (u--tapeC-39) (Main-run arg-1 (cons u--op e-3) u--tapeC-39)))))))))))))))))
(define Main-runFresh (lambda (arg-1 arg-2) (Main-run arg-1 arg-2 (vector '() 0 '()))))
(define Main-runQuiet (lambda (ext-0) (Builtin-fst ((Main-runFresh (cons csegen-25 (lambda (arg-5936) (Main-u--write_Ctx_Quiet arg-5936))) ext-0) (cons 0 0)))))
...
(define Main-verified (let ((u--ops (Main-parse (PreludeC-45Types-fastUnpack "++++++++[>++++[>++>+++>+++>+<<<<-]>+>+>->>+[<]<-]>>.>---.+++++++..+++.>>.<-.<.+++.------.--------.>>+.>++.")))) (let ((u--csActual (Main-runQuiet u--ops))) (let ((u--csExpected (PreludeC-45Types-u--foldl_Foldable_List (lambda (u--cs) (lambda (u--c) (Main-accCheckSum (cast-char-boundedInt u--c 63) u--cs))) (cons 0 0) (PreludeC-45Types-fastUnpack "Hello World!\xa;")))) (lambda (eta-0) (PreludeC-45EqOrd-u--C-61C-61_Eq_C-40C-124C-40C-40BuiltinC-46PairC-32C-36aC-41C-32C-36bC-41C-44C-40C-40BuiltinC-46MkPairC-32C-36aC-41C-32C-36bC-41C-124C-41 csegen-50 csegen-50 u--csActual u--csExpected))))))
(define NetworkC-45Socket-close (lambda (arg-1 arg-2) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (NetworkC-45FFI-prim__idrnet_close (let ((e-0 (vector-ref arg-2 0))) e-0) eta-0))))) (lambda (u--_) (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) 'erased))))))))))
...
(define NetworkC-45SocketC-45Data-u--show_Show_SocketAddress (lambda (arg-0) (case (vector-ref arg-0 0) ((0) (let ((e-0 (vector-ref arg-0 1))) (let ((e-1 (vector-ref arg-0 2))) (let ((e-2 (vector-ref arg-0 3))) (let ((e-3 (vector-ref arg-0 4))) (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8530) (lambda (arg-8533) (string-append arg-8530 arg-8533))) "") (lambda (eta-0) eta-0) (DataC-45List-intersperse "." (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (PreludeC-45Show-u--show_Show_Int eta-0)) (cons e-0 (cons e-1 (cons e-2 (cons e-3 '())))))))))))) ((1) "NOT IMPLEMENTED YET") ((2) (let ((e-4 (vector-ref arg-0 1))) e-4)) (else "Invalid"))))
...
(define NetworkC-45Socket-connect (lambda (arg-1 arg-2 arg-3 arg-4) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (NetworkC-45FFI-prim__idrnet_connect (let ((e-0 (vector-ref arg-2 0))) e-0) (NetworkC-45SocketC-45Data-u--toCode_ToCode_SocketFamily (let ((e-10 (vector-ref arg-2 1))) e-10)) (NetworkC-45SocketC-45Data-u--toCode_ToCode_SocketType (let ((e-9 (vector-ref arg-2 2))) e-9)) (NetworkC-45SocketC-45Data-u--show_Show_SocketAddress arg-3) arg-4 eta-0))))) (lambda (u--conn_res) (let ((sc1 (PreludeC-45EqOrd-u--C-61C-61_Eq_Int u--conn_res (blodwen-toSignedInt -1 63)))) (cond ((equal? sc1 1) (NetworkC-45SocketC-45Data-getErrno arg-1)) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) (blodwen-toSignedInt 0 63))))))))))))))
...
(define System-die (lambda (arg-2 arg-3) (let ((e-1 (car arg-2))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-7 (car arg-2))) (let ((e-10 (vector-ref e-7 0))) (let ((e-13 (vector-ref e-10 0))) ((((e-13 'erased) 'erased) (lambda (eta-0) 'erased)) (SystemC-45FileC-45ReadWrite-fPutStrLn arg-2 SystemC-45FileC-45Virtual-stderr arg-3)))))) (lambda (_-10718) (System-exitFailure arg-2)))))))
(define NetworkC-45Socket-send (lambda (arg-1 arg-2 arg-3) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (NetworkC-45FFI-prim__idrnet_send (let ((e-0 (vector-ref arg-2 0))) e-0) arg-3 eta-0))))) (lambda (u--send_res) (let ((sc1 (PreludeC-45EqOrd-u--C-61C-61_Eq_Int u--send_res (blodwen-toSignedInt -1 63)))) (cond ((equal? sc1 1) (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-13 (vector-ref e-10 0))) ((((e-13 'erased) 'erased) (lambda (eta-0) (vector 0 eta-0))) (NetworkC-45SocketC-45Data-getErrno arg-1)))))) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) (vector 1 u--send_res))))))))))))))
...
(define Main-notify (lambda (arg-0 ext-0) (let ((act-1 ((NetworkC-45Socket-socket csegen-43 2 1 0) ext-0))) (case (vector-ref act-1 0) ((1) (let ((e-2 (vector-ref act-1 1))) (let ((act-2 ((NetworkC-45Socket-connect csegen-43 e-2 (vector 2 "localhost") (blodwen-toSignedInt 9001 63)) ext-0))) (let ((act-3 ((NetworkC-45Socket-send csegen-43 e-2 arg-0) ext-0))) (case (vector-ref act-3 0) ((1) ((NetworkC-45Socket-close csegen-43 e-2) ext-0)) (else (let ((e-5 (vector-ref act-3 1))) ((System-die csegen-43 (string-append "Error in call to send: " (PreludeC-45Show-u--show_Show_Int e-5))) ext-0)))))))) (else (let ((e-5 (vector-ref act-1 1))) ((System-die csegen-43 (string-append "Error in call to socket: " (PreludeC-45Show-u--show_Show_Int e-5))) ext-0)))))))
(define Main-checkSum (lambda (arg-0) (let ((e-2 (car arg-0))) (let ((e-3 (cdr arg-0))) (blodwen-or (blodwen-bits-shl-signed e-3 (blodwen-toSignedInt 8 63) 63) e-2)))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (Main-verified ext-0))) (cond ((equal? act-1 1) (let ((act-2 ((System-getArgs csegen-43) ext-0))) (if (null? act-2) ((blodwen-error-quit (string-append "ERROR: " "Unhandled input for Main.case block in case block in main at Main:108:1--125:20")) ext-0) (let ((e-2 (cdr act-2))) (if (null? e-2) ((blodwen-error-quit (string-append "ERROR: " "Unhandled input for Main.case block in case block in main at Main:108:1--125:20")) ext-0) (let ((e-4 (car e-2))) (let ((e-5 (cdr e-2))) (if (null? e-5) (let ((act-3 ((SystemC-45FileC-45ReadWrite-readFile csegen-43 e-4) ext-0))) (case (vector-ref act-3 0) ((1) (let ((e-3 (vector-ref act-3 1))) (let ((act-4 ((System-getEnv csegen-43 "QUIET") ext-0))) (let ((act-5 ((System-getPID csegen-43) ext-0))) (let ((act-6 (Main-notify (string-append "Idris (FP)\x9;" (PreludeC-45Show-u--show_Show_Int act-5)) ext-0))) (((let ((u--ops (Main-parse (PreludeC-45Types-fastUnpack e-3)))) (if (null? act-4) (lambda () (lambda (world-0) (let ((act-7 ((Main-runFresh (cons (force csegen-42) (lambda (arg-5936) (lambda (eta-0) (Main-u--write_Ctx_Loud arg-5936 eta-0)))) u--ops) world-0))) (Main-notify "stop" world-0)))) (let ((u--cs (Main-runQuiet u--ops))) (lambda () (lambda (world-0) (let ((act-7 (Main-notify "stop" world-0))) (PreludeC-45IO-prim__putStr (string-append (string-append "Output checksum: " (PreludeC-45Show-u--show_Show_Int (Main-checkSum u--cs))) "\xa;") world-0)))))))) ext-0)))))) (else (let ((e-6 (vector-ref act-3 1))) ((System-die csegen-43 (string-append "Error reading file: " (SystemC-45FileC-45Error-u--show_Show_FileError e-6))) ext-0))))) ((blodwen-error-quit (string-append "ERROR: " "Unhandled input for Main.case block in case block in main at Main:108:1--125:20")) ext-0))))))))) (else ((System-die csegen-43 "Verification failed.") ext-0))))))
